        ...
        <section class="content-header">
            ...
            <div class="row mb-2">
                ...
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">All Terms And Conditions</li>
                </ol>
                </div>
            </div>
            </div><!-- /.container-fluid -->
                  ...
                  <tbody>
                   ...
                   @foreach ($allTerms as $term)
                        <tr>
                            ...
                            <td>{{$term->term_title_ar}}</td>
                            <td class="text-center">
                              <a href="{{url('admin/terms-conditions/'.$term->term_id.'/edit')}}" class="btn btn-outline-warning rounded"><i class="fas fa-edit"></i></a>

                            </td>
                            <td class="text-center">
                                <form action="{{url('admin/terms-conditions/'.$term->term_id)}}" method="post" style="display: inline">
                                    @csrf
                                    @method('DELETE')
