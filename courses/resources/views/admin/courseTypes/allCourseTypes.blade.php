        ...
        <section class="content-header">
            ...
            <div class="row mb-2">
                ...
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">All Course Types</li>
                </ol>
                </div>
            </div>
            </div><!-- /.container-fluid -->
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover text-center">
                  ...
                  <tr>
                    ...
                    <th>course type (EN) </th>
                    <th>course type (AR) </th>
                    <th>Edit</th>
                    <th>Delete</th>
                  ...
                  <tbody>
                   ...
                   @foreach ($allCourseTypes as $courseType)
                        <tr>
                            <td>{{$courseType->course_type_id}}</td>
                            <td>{{$courseType->course_type_name}}</td>
                            <td>{{$courseType->course_type_name_ar}}</td>
                            <td class="text-center">
                              <a href="{{url('admin/course-types/'.$courseType->course_type_id.'/edit')}}" class="btn btn-outline-warning rounded"><i class="fas fa-edit"></i></a>
                            </td>
                            <td class="text-center">
                                <form action="{{url('admin/course-types/'.$courseType->course_type_id)}}" method="post" style="display: inline">
                                    @csrf
                                    @method('DELETE')
