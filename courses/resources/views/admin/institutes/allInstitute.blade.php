                    ...
                    @isset($institutes)
                        @foreach ($institutes as $inst)
                            <tr>
                                ...
                                <td>{{$inst->i_created_at}}</td>
                                <td class="text-center">
                                  <a href="{{url('admin/institute/'.$inst->institute_id)}}" class="btn btn-outline-warning rounded"><i class="fas fa-edit"></i></a>
                                </td>
                                <td class="text-center">

                                   
                                    <form action="{{url('admin/institute/'.$inst->institute_id)}}" method="post" style="display: inline">
                                        @method('DELETE')
                                        @csrf
