...
@section('content')
    ...
    <section class="content">
        ...
        <section class="content-header">
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                <h1>Confirmed revervation</h1>
                </div>
                <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    {{-- <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li> --}}
                    <li class="breadcrumb-item active">Confirmed revervation</li>
                </ol>
                </div>
            </div>
            </div><!-- /.container-fluid -->
                            ...
                            <tr>
                                <td>{{$re->reservation_id}}</td>
                                      ...
                                      <td class="text-center">
                                          <form action="{{url('admin/reservation/'.$re->reservation_id)}}" method="post" style="display: inline">
                                              @method('DELETE')
                                              @csrf
