                  ...
                  <tbody>
                   ...
                   @foreach ($allSliders as $slider)
                        <tr>
                            ...
                            <td>{{$slider->slider_title_ar}}</td>
                            <td>{{$slider->slider_link}} </td>
                            <td class="text-center">
                              <a href="{{url('admin/slider/'.$slider->slider_id.'/edit')}}" class="btn btn-outline-warning rounded"><i class="fas fa-edit"></i></a>
                            </td>
                            <td class="text-center">
                                <form action="{{url('admin/slider/'.$slider->slider_id)}}" method="post" style="display: inline">
                                    @csrf
                                    @method('DELETE')
