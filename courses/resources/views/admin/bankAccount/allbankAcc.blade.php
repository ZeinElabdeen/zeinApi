                   ...
                   @foreach ($allAccs as $acc)
                        <tr>
                            ...
                            <td class="text-center">
                              <a href="{{url('admin/bankAccount/'.$acc->account_id)}}" class="btn btn-outline-warning rounded"><i class="fas fa-edit"></i></a>

                            </td>
                            <td class="text-center">
                                <form action="{{url('admin/bankAccount/'.$acc->account_id)}}" method="post" style="display: inline">
                                    @csrf
                                    @method('DELETE')
