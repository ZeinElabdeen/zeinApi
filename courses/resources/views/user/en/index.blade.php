@extends('user.en.layouts.lay') @section('title','Home')
@section('links')
    ...
    <link rel="stylesheet" href="{{url('assets-en/css/home.css')}}">
    ...
    @foreach ($slider as $key => $slide)
      <div class="carousel-item {{ $loop->first ? 'active' : '' }} ">
          ...
          <div class="carousel-caption">
            ...
            <a href="{{ $slide['slider_link'] }}">More</a>
          </div>
  ...
  <form action="{{url('courses-search')}}" method="get">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-sm-12 col-lg-2">
        <button type="submit" style="background-color: #ffae00;padding: 10px 10px;display: inline-block;margin-top: 22px;color: #fff;text-transform: uppercase;border-radius: 25px;border:0">Search Now</button>
        </div>
        </div>
      </div>
    </div>
...
<section class="about">
  <div class="container">
      <div class="row">
          ...
          <div class="col-sm-12  col-lg-6">
              <img src="{{asset('storage/images/about.png')}}" alt="about" width="100%">
          </div>
      </div>
  </div>
</section>
        ...
        <div class="row">
          <div class="col-6 text-left">
            <button type="button" class="btn ">
              <a href="#" class="price">{{$course['course_price']}} SAR </a>
            </button>
          </div>
...
<div class="col-sm-12 col-md-12 col-lg-12 text-center">
  <a href="{{url('all-courses')}}" class="btn btn-warning"> Show More <i class="fas fa-angle-double-right"></i></a>
</div>
   ...
   <div class="container">
    <div class="row">
     <div class="col-sm-12 col-md-12 col-lg-12">
          ...
          <div class="card-footer">
            <div class="row">
              <div class="col-7 text-left">
                <button type="button" class="btn ">
                    <a href="#" class="price">{{$inst['courses_count']}} Courses </a>
                </button>
            </div>
      ...
      <div class="col-sm-12 col-md-12 col-lg-12 text-center">
        <a href="{{url('all-institutes')}}" class="btn btn-warning"> Show More <i class="fas fa-angle-double-right"></i></a>
      </div>
    </div>
  </div>
  </section>
