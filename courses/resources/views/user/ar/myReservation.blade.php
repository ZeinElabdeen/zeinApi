@extends('user.ar.layouts.lay') @section('title',' حجوزاتي ') @section('links')
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
        <div class="banner">
            {{-- <h2>من نحن</h2> --}}
            <span class="text-light">الرئيسية / <span> حجوزاتي  </span>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container">
     ...
     <div class="col-sm-12">
      <ul class="nav nav-pills nav-button mb-3" id="pills-tab" role="tablist">
        <li class="nav-item">
          <a class="nav-link  active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">الحجوزات الحالية</a>
        </li>
        <li class="nav-item"> 
          <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">الحجوزات السابقة</a>
        </li>
      </ul>
    </div>
                            ...
                            <div class="card " >
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-sm-12 col-md-9 co-lg-8">
                                        <div class="card-body">
                                        <h6>رقم الحجز: <span>{{$reservation['reservation_id']}}</span></h6>
                                            <span class="top">منذ : <span>{{$reservation['from']}}</span></span>
                                        ...
                                        <h6>السعر: <span>{{$reservation['total']}} رس</span></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
