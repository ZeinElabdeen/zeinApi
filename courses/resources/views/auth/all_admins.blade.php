                        ...
                        @foreach ($admins as $admin)
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="{{url('/admin/get-profile/'.$admin->id)}}" class="btn btn-outline-warning rounded"><i class="fas fa-edit"></i></a>
                                    <form action="{{url('/admin/delete-admin/'.$admin->id)}}" method="post" style="display: inline">
                                        @method('DELETE')
                                        @csrf
