                    ...
                    <form id="change-pwd" action="{{url('dashboard/setting/update')}}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 form-group mb-3">
                                <label for="value">الوصف بالعربية :</label>
                                <textarea type="text" class="form-control" style="margin-top: 0px; margin-bottom: 0px; height: 256px;" name="value" rows="5" id="value" >{{$data->value}}</textarea>
                                @if ($errors->has('value'))
                                    <span class="text-danger" role="alert">
                                        <strong>الوصف مطلوب بالعربية</strong>
                                    </span>
                                @endif
                            </div>
