                                    ...
                                    @if(count($data)>0 && !empty($data))
                                        @foreach($data as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{config('plan_storage'). $item->membership_image}}" width="120" height="60" alt="">
                                                    </td>
                                                <td>
                                                    <a href="{{url('/dashboard/user/accept-membership/'.$item->id)}}" class="la la-check btn btn-success"> قبول</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif
