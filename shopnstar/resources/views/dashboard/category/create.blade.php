                    ...
                    <form id="change-pwd" action="{{url('dashboard/category/store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group mb-3">
                                ...
                                <textarea  class="form-control" name="description" id="description" style="margin-top: 0px; margin-bottom: 0px; height: 135px;" placeholder="الوصف" >{{old('description')}}</textarea>
