                                    ...
                                    @if(count($data)>0 && !empty($data))
                                        @foreach($data as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    @if( $item->statu == '1')
                                                    <a  class="badge badge-success status-btn" style="width:80px;height: 25px;padding:auto;margin:auto;
                                                      padding-top: 7px; font-size: small">فعال</a>
                                                    @else
                                                    <a   class="badge badge-danger status-btn" style="width:80px;height: 25px;padding:auto;margin:auto;
