                    ...
                    <form id="change-pwd" action="{{url('dashboard/setting/update')}}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 form-group mb-3">
                                <label for="value_ar">{{$title}} العربي :</label>
                                <textarea type="text" class="form-control" name="value_ar" rows="15" id="value_ar" >{{$data->value_ar}}</textarea>
                            ...
                            <div class="col-md-12 form-group mb-3">
                                <label for="value_en">{{$title}} الانجليزي :</label>
                                <textarea type="text" class="form-control" name="value_en" rows="15" id="value_en" >{{$data->value_en}}</textarea>
