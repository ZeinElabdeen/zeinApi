        ...
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form id="change-pwd" action="{{url('dashboard/faq/store')}}" method="post">
                        @csrf
                        <div class="row">

                            <div class="col-md-8 form-group mb-3">
                                <label for="question_ar">السؤال بالعربية :</label>
                                <textarea type="text" class="form-control" name="question_ar" rows="5" id="question_ar" >{{old('question_ar')}}</textarea>
                                @if ($errors->has('question_ar'))
                                    <span class="text-danger" role="alert">
                                        <strong>السؤال بالعربية مطلوب</strong>
                                    </span>
                                @endif
                            </div>
                            ...
                            <div class="col-md-8 form-group mb-3">
                                ...
                                <textarea type="text" class="form-control" name="answer_ar" rows="5" id="answer_ar" >{{old('answer_ar')}}</textarea>
                                @if ($errors->has('answer_ar'))
                                    <span class="text-danger" role="alert">
                                      <strong>الإجابة مطلوبة</strong>
                                    </span>
                                @endif
                            </div>
                            ...
                            <div class="col-md-8 form-group mb-3">
                                ...
                                <textarea type="text" class="form-control" name="question_en" rows="5" id="question_en" >{{old('question_en')}}</textarea>
                                @if ($errors->has('question_en'))
                                    <span class="text-danger" role="alert">
                                        <strong>السؤال بالانجليزية مطلوب</strong>
                                    </span>
                                @endif
                            </div>

                            <div class="col-md-8 form-group mb-3">
                              <label for="answer_en">الإجابة بالانجليزية :</label>
                                <textarea type="text" class="form-control" name="answer_en" rows="5" id="answer_en" >{{old('answer_en')}}</textarea>
