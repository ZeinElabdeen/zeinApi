    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form id="change-pwd" action="{{url('dashboard/faq/update')}}" method="post">
                        @csrf
                        <div class="row">
                            <input type="hidden" name="id" value="{{$data->id}}" hidden readonly>
                            <div class="col-md-8 form-group mb-3">
                                <label for="question_ar">السؤال بالعربية :</label>
                                <textarea type="text" class="form-control" name="question_ar" rows="5" id="question_ar" >{{$data->question_ar}}</textarea>
                            ...
                            <div class="col-md-8 form-group mb-3">
                                ...
                                <textarea type="text" class="form-control" name="answer_ar" rows="5" id="answer_ar" >{{$data->answer_ar}}</textarea>
                            ...
                            <div class="col-md-8 form-group mb-3">
                                ...
                                <textarea type="text" class="form-control" name="question_en" rows="5" id="question_en" >{{$data->question_en}}</textarea>
                            ...
                            <div class="col-md-8 form-group mb-3">
                                ...
                                <textarea type="text" class="form-control" name="answer_en" rows="5" id="answer_en" >{{$data->answer_en}}</textarea>
