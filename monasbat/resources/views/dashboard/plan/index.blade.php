                ...
                <div class="card text-left">
                    <div class="card-header">
                        <div class="card-title mb-3">
                            <strong class="text-primary"> قائمة الباقات</strong>
                            <span class="align-baseline" style="display:inline;">
                                <a class="btn btn-primary " href="{{url('dashboard/plan/create')}}" style="float: left">
                                <i class="i-Add align-middle" style="font-size: 17px; font-weight: 600;"></i> إضافة باقة  </a>
                            </span>
                        </div>
                    </div>
                                        ...
                                        @foreach($data as $item)
                                            <tr>
                                                ...
                                                <td style="text-align: center;">
                                                    <a href="{{url('dashboard/plan/edit/'.$item->id)}}" class="text-info mr-2">
                                                        <i class="nav-icon i-Eye font-weight-bold " ></i>
                                                    </a>
                                                    <a href="{{url('dashboard/plan/delete/'.$item->id)}}" class="text-danger mr-2">
