...
//        }
        ...
        return $this->apiResponse(['message'=> trans('user.reset_pwd.code_sent'),'reset_password_code' => $token ],200);
    ...
    public function check () {
        ...
        if (!$user) {
            return $this->apiResponse(['message'=> trans('user.reset_pwd.code_expire') ],200);
        }
