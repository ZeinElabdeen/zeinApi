...
<head>
    ...
    <title> Power dashboard | Login</title>
            ...
            <div class="row align-content-center">
                <div class="col-md-12 text-center">
                    <div class="p-4">
                        ...
                        <h1 class="mb-3 text-18" style="color: #7f00ff;">الدخول إلى لوحة التحكم</h1>
                        @include('dashboard.layouts.message')
                        <form action="{{url('admin/login_post')}}" method="post">
                            @csrf
                            <div class="form-group">
                                <label for="email" style="color: #7f00ff;font-size: 16px;">البريد الإلكتروني</label>
                            ...
                            <div class="form-group">
                                <label for="password" style="color: #7f00ff;font-size: 16px;">كلمة المرور</label>
...
{{--                                    <a href="{{route('admin.forgetPassword.get')}}" style="color: #5504a5;"><u>نسيت كلمة المرور</u></a>--}}
                            ...
                            style="background-color: #7f00ff;border-color: #7f00ff;">تسجيل الدخول</button>
