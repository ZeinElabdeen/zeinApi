                    ...
                    <form id="change-pwd" action="{{url('dashboard/setting/updateContact')}}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 form-group mb-3">
                                <label for="value_ar">السعر :</label>
                                <input type="number" min="1"   class="form-control"  name="value" id="value" value="{{$data->value_en}}" required />
                                @if ($errors->has('value'))
                                    <span class="text-danger" role="alert">
                                        <strong> السعر مطلوب ويجب ان يكون رقم</strong>
                                    </span>
                                @endif
                            </div>
