                        ...
                        <div class="row">
                          ...
                          <div class="col-md-12">
                            ...
                            <div class="col-md-6 form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="car_number" value="{{$data->car_number}}" readonly >
                            </div>
                            ...
                            <div class="col-md-6 form-group mb-4">
                                <div class="avatar-upload" style="text-align: left;margin: 30px;">
                                  <label for="car_insurance_image"> صورة تامين السيارة </label>
                                  </br>
                                  <span>اضغط للعرض</span>
                                  <a href="{{config('driver_storage').$data->car_insurance_image}}" target="_blank" >
                                    <div class="avatar-preview" style="width: 350px; height: 200px;border: dotted;border-radius: 10%;border-color: rebeccapurple;" >
                                        <div id="imagePreview" style="background-image: url({{config('driver_storage').$data->car_insurance_image}});border-radius: 10%;">
                                        </div>
                                    </div>
                                   <a>
                                </div>
                            ...
                            <div class="col-md-6 form-group mb-4" id="status_div">
