...
class RegisterController extends ResponseController
{
    public function register(Request $request)
    {
        ...
        $this->validate(request(), [
            ...
            'car_number'    => 'required|string:max:191',
            ...
            'car_insurance_image'    => 'required|image|mimes:jpg,jpeg,png|max:5120',
        ...
        $car_insurance_image = $this->uploadImage(request()->car_insurance_image,'driver');
        ...
        $data = Driver::create([
            ...
            'car_insurance_image' => $car_insurance_image,
