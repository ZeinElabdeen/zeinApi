...
class SettingController extends Controller
{
    ...
    public function edit ($key) {
        ...
        switch ($key) {
          ...
          case 'rate_percent':
              $title = "نسبة الشركة من الطلب";
              $data = Setting::where('key','rate_percent')->first();
              return view('dashboard.setting.rate_percent',compact('data','title'));
              break;

          case 'km_price':
              $title = "سعر الكيلو متر";
              $data = Setting::where('key','km_price')->first();
              return view('dashboard.setting.km_price',compact('data','title'));
              break;
        }
    }
