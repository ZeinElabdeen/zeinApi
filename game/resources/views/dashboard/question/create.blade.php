    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form id="change-pwd" action="{{url('dashboard/question/store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                          <div class="col-md-12">
                            ...
                            <div class="col-md-6 form-group mb-3">
                                ...
                                <input type="text" class="form-control" name="title" id="title" placeholder="السؤال " value="{{old('title')}}" autocomplete="off">
                                @if ($errors->has('title'))
                                    <span class="text-danger" role="alert">
