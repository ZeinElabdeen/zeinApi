    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form id="change-pwd" action="{{url('dashboard/category/minors/update')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="avatar-upload">
                                    ...
                                    <div class="avatar-preview">
                                        <div id="imagePreview" style="background-image: url({{config('category_storage').$data->icon}});">
                                        </div>
                                    </div>
                                </div>
                                @if ($errors->has('image'))
                            ...
                            <div class="col-md-6 form-group mb-3">
                                <label for="title_ar">القسم الرئيسي</label>
                                <select class="form-control" name="parent_id" >
                                  @foreach($majors as $row)
                                    <option value="{{$row->id}}" @if($row->id == $data->parent_id) selected @endif> {{ $row->title_ar }}</option>
                                  @endforeach
                                </select>
