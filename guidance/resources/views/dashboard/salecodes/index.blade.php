                                        ...
                                        @foreach($data as $item)
                                            <tr>
                                                ...
                                                <td  style="text-align: center;">
                                                    @if( $item->statu == '1')
                                                    <a  class="badge badge-success status-btn" style="padding: 9px;font-size: small;color: white;width: 90px;">غير مستخدم</a>
                                                    @else
                                                    <a  class="badge badge-danger status-btn" style="padding: 9px;font-size: small;color: white;width: 90px;">مستخدم</a>
