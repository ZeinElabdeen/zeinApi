        ...
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-header">
                    <div class="card-title mb-3">  <strong class="text-primary">إضافة كود شحن </strong></div>
                </div>
                    ...
                    <form id="insert-form" action="{{url('dashboard/salecodes/store')}}" method="post" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group mb-3">
                                ...
                                <input type="number" min="1"  class="form-control" name="salevalue" id="salevalue" placeholder="قيمه الشحن" value="{{old('salevalue')}}" autocomplete="off">
                            ...
                            <div class="col-md-3 form-group mb-3">
                                ...
                                <input type="text" class="form-control" name="codeview" id="codeview" placeholder="كود الشحن" value="{{old('code')}}" autocomplete="off" disabled >
                                @if ($errors->has('code'))
                                    <span class="text-danger" role="alert">
