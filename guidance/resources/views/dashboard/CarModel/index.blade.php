                ...
                <div class="card text-left">
                    <div class="card-header">
                        <div class="card-title mb-3">
                            <strong class="text-primary"> قائمة الموديلات </strong>
                            <span class="align-baseline" style="display:inline;">
                                <a class="btn btn-primary " href="{{url('dashboard/car_models/create')}}" style="float: left">
                                <i class="i-Add align-middle" style="font-size: 17px; font-weight: 600;"></i> إضافة موديل جديد </a>
                            </span>
                        </div>
                    </div>
                        ...
                        @if(count($data) > 0)
                            <div class="table-responsive">
                                <table id="alternative_pagination_table" class="display table table-striped table-bordered" style="width:100%">
                                    ...
                                    <tr>
                                        <th>#</th>
                                        <th>اسم الموديل بالعربي</th>
                                        <th>اسم الموديل بالانجليزية</th>
                                        <th>التحكم </th>
                                        ...
                                        @foreach($data as $item)
                                            <tr>
                                                ...
                                                <td style="text-align: center;">
                                                    <a href="{{url('dashboard/car_models/edit/'.$item->id)}}" class="text-info mr-2">
                                                        <i class="nav-icon i-Edit font-weight-bold " ></i>
                                                    </a>
                                                    <a href="{{url('dashboard/car_models/delete/'.$item->id)}}" class="text-danger mr-2">
