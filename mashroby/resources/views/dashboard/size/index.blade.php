                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            ...
                            <a href="{{url('dashboard/size/create')}}" class="btn btn-brand btn-elevate btn-icon-sm">
                ...
                @if(count($data) > 0)
                    ...
                    @foreach($data as $index => $item)
                        <tr>
                            ...
                            <td>55</td>
                            <td>
                                <form method="post" action="{{url('dashboard/size/delete')}}" style="display: inline-block;">
                                    @csrf
                                    @method('delete')
                                ...
                                <a class="btn  btn-xs" href="{{url('dashboard/size/edit/'.$item->id)}}" style="padding:0px"><i class="text-primary fa fa-edit la-lg"></i></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
