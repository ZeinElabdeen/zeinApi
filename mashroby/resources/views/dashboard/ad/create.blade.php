...
{{--            <div class="col-lg-12">--}}
        ...
        <div class="kt-wizard-v4" id="kt_user_add_user" data-ktwizard-state="step-first">
            ...
            <div class="kt-portlet">
                ...
                <!--begin::Form-->
                <form class="kt-form" id="create-ad" method="post" action="{{url('dashboard/ad/store')}}" enctype="multipart/form-data">
                    @csrf
                                                        ...
                                                        <div class="kt-section__body">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-9 col-xl-9">
                                                                    <input class="form-control {{ $errors->has('title_ar') ? ' is-invalid' : '' }}" name="title_ar" value="{{old('title_ar')}}" type="text" placeholder="يجب ان يكون الاسم باللغة العربية" required >
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-9 col-xl-9">
                                                                    <input class="form-control {{ $errors->has('title_en') ? ' is-invalid' : '' }}" name="title_en" value="{{old('title_en')}}" type="text" required >
                                                                ...
                                                                <div class="col-lg-9 col-xl-9">
                                                                    <select class="form-control {{ $errors->has('size') ? ' is-invalid' : '' }}" name="size" id="exampleSelect1" style="height: auto;">
                                                                        ...
                                                                        @foreach($sizes as $size)
                                                                            <option value="{{$size->id}}" {{(old('size') == $size->id)?'selected':''}}>{{$size->title_ar .' - '. $size->title_en}}</option>
                                                                        @endforeach
                                                                    </select>
                                                                    @if ($errors->has('size'))
                                                                        <span class="form-text text-danger" role="alert">
                                                                ...
                                                                <div class="col-lg-9 col-xl-9">
                                                                    <select class="form-control {{ $errors->has('category') ? ' is-invalid' : '' }}" name="category" id="exampleSelect1" style="height: auto;">
                                                                        ...
                                                                        @foreach($categories as $category)
                                                                            <option value="{{$category->id}}" {{(old('category') == $category->id)?'selected':''}}>{{$category->title_ar .' - '. $category->title_en}}</option>
                                                                        @endforeach
                                                                    </select>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-9 col-xl-9">
                                                                    <input class="form-control {{ $errors->has('stock') ? ' is-invalid' : '' }}" name="stock" value="{{old('stock')}}" type="number" min="1" required>
                                                                    @if ($errors->has('stock'))
                                                                        <span class="form-text text-danger" role="alert">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-9 col-xl-9">
                                                                    <input class="form-control {{ $errors->has('price') ? ' is-invalid' : '' }}" name="price" value="{{old('price')}}" type="number" min="1" required >
                                                                    @if ($errors->has('price'))
                                                                        <span class="form-text text-danger" role="alert">
                                                                ...
                                                                <div class="col-9">
                                                                    <div class="kt-radio-inline">
                                                                        ...
                                                                        <label class="kt-radio kt-radio--success">
                                                                            <input type="radio" id="ad-type" name="type" value="2" {{(old('type') == '2')?'checked':''}}> عرض
                                                                            <span></span>
                                                                        </label>
                                                                        </div>
{{--                                                                    <span class="form-text text-muted">Some help text goes here</span>--}}
                                                                ...
                                                                <div id="discount-div" class="form-inline col-6" hidden>
                                                                    <div class="form-group input-group ">
                                                                        <input class="form-control {{ $errors->has('discount') ? ' is-invalid' : '' }}" name="discount" value="{{old('discount')}}" type="number" min="1" max="100">
