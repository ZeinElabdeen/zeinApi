...
@section('content')
{{--    <link rel="stylesheet" href="{{asset('dashboard_assets/datatables.min.css')}}">--}}
                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            ...
                            <a href="{{url('dashboard/admin/create')}}" class="btn btn-brand btn-elevate btn-icon-sm">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="post" action="{{url('dashboard/admin/delete')}}">
                                  <a class="btn  btn-xs" href="{{url('dashboard/admin/edit/'.$item->id)}}" style="padding:0px">
                                    <i class="text-primary fa fa-edit la-lg"></i>
                                  </a>
                                    @csrf
                                    @method('delete')
