...
{{--                            <a href="{{url('dashboard/plan/create')}}" class="btn btn-brand btn-elevate btn-icon-sm">--}}
                ...
                @if(count($data) > 0)
                    ...
                    @foreach($data as $index => $item)
                        <tr>
                            ...
                            <td>
                                <a class="btn  btn-xs" href="{{url('dashboard/plan/edit/'.$item->id)}}" style="padding:0px"><i class="text-primary fa fa-edit la-lg"></i></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
