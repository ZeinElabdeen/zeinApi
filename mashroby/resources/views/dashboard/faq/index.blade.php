                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            ...
                            <a href="{{url('dashboard/faq/create')}}" class="btn btn-brand btn-elevate btn-icon-sm">
            ...
            <div class="kt-portlet__body">
                ...
                @if(count($data) > 0)
                    ...
                    <tr>
                        <th>#</th>
                        <th>السؤال العربي</th>
                        <th>الإجابة العربي</th>
                        <th>السؤال الانجليزي</th>
                        <th>الإجابة الانجليزي</th>
                        <th></th>
                    </tr>
                    </thead>
                    <tbody>
                    @foreach($data as $index => $item)
                        <tr>
                            ...
                            <td>
                                <form method="post" action="{{url('dashboard/faq/delete')}}" style="display: inline-block;">
                                    @csrf
                                    @method('delete')
                                ...
                                <a class="btn  btn-xs" href="{{url('dashboard/faq/edit/'.$item->id)}}" style="padding:0px"><i class="text-primary fa fa-edit la-lg"></i></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
