        ...
        <div class="container">
            ...
            <div class="col-lg-12">
                ...
                <div class="kt-portlet">
                    ...
                    <!--begin::Form-->
                    <form class="kt-form" action="{{url('dashboard/user/update')}}"  method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="kt-portlet__body">
                            <div class="kt-section kt-section--first">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="phone" value="{{$data->phone}}" placeholder="رقم الهاتف">
                                    @if ($errors->has('phone'))
                                        <span class="form-text text-muted">
                                            <strong class="text text-danger">رقم الهاتف مطلوب</strong>
                                        </span>
                                    @endif
                                </div>
