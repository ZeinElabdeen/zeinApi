                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            ...
                            <a href="{{url('dashboard/category/create')}}" class="btn btn-brand btn-elevate btn-icon-sm">
                ...
                @if(count($data) > 0)
                    ...
                    @foreach($data as $index => $item)
                        <tr>
                            ...
                            <td>{{$item->title_en}}</td>
                            <td>
                                <form method="post" action="{{url('dashboard/category/delete')}}" style="display: inline-block;">
                                    @csrf
                                    @method('delete')
                                ...
                                <a class="btn  btn-xs" href="{{url('dashboard/category/edit/'.$item->id)}}" style="padding:0px"><i class="text-primary fa fa-edit la-lg"></i></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
