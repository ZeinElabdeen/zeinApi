                    ...
                    <form id="change-pwd" action="{{url('dashboard/faq/update')}}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 form-group mb-3">
                                <label for="question">الإجابة :</label>
                                <textarea type="text" class="form-control" name="question" rows="5" id="question" >{{$data->question}}</textarea>
                            ...
                            <div class="col-md-8 form-group mb-3">
                                ...
                                <textarea type="text" class="form-control" name="answer" rows="5" id="answer" >{{$data->answer}}</textarea>
