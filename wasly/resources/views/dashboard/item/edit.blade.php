    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form id="form" action="{{url('dashboard/item/update')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group mb-3">
                                ...
                                <input type="text" class="form-control" name="price" id="price" placeholder="السعر " value="{{$data->price}}" autocomplete="off">
                                @if ($errors->has('price'))
                                    <span class="text-danger" role="alert">
...
{{--                                    <option selected disabled>اختر البراند </option>--}}
                                    @foreach($brands as $brand)
                                        <option value="{{$brand->id}}" {{($brand->id == $data->brand_id)??'selected'}}>{{$brand->title}}</option>
                                    @endforeach
                                </select>
                                @if ($errors->has('brand'))
                                    <span class="text-danger" role="alert">
                            ...
                            <div class="col-md-6 form-group mb-3">
                                ...
                                <select class="form-control attribute" name="classification" id="classification" >
                                    @foreach($data->brand->classifications as $row)
                                        <option value="{{$row->id}}" {{($row->id == $data->classification)??'selected'}}>{{$row->title}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-8 form-group mb-3">
                                ...
                                <textarea  class="form-control" name="description" rows="5" id="description" >{{$data->description}}</textarea>
                            ...
                            <div class="card-body" style="display: block">
                                <div class="row">
                                    @foreach($data->attaches as $attach)
                                        <div class="col-3" style="margin-bottom: 15px; height: 250px;">
                                            <div class="custom-file">
                                                <a class="image_delete_link" href="{{route('dashboard.deleteAttach',['id' => $attach->id])}}"  ><i class="i-Close text-danger"></i></a>
                                                <img src="{{config('attach_storage').$attach->image}}"  style="margin-bottom: 15px; width: 260px; height: 240px;" alt="">
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
                            ...
                            <div class=" col-md-12 ">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="input-group control-group ">
                                        <input type="text"  class="form-control custom-input" readonly value="{{$detail->key}}" placeholder=" الصفة " >
                                        <input type="text"  class="form-control custom-input" readonly value="{{$detail->value}}" placeholder="القيمة ">
                                        <div class="input-group-btn">
                                            <a href="{{route('dashboard.deleteDetail',['id' => $attach->id])}}" class="btn btn-danger" type="button"><i class="glyphicon glyphicon-remove"></i> حذف</a>
                                        </div>
                                    </div>
                                    <br>
                                    @endforeach
