                ...
                <div class="card text-left">
                    <div class="card-header">
                        <div class="card-title mb-3">
                            <strong class="text-primary"> قائمة التصنيفات</strong>
                            <span class="align-baseline" style="display:inline;">
                                <a class="btn btn-primary " href="{{url('dashboard/classification/create')}}" style="float: left">
                                <i class="i-Add align-middle" style="font-size: 17px; font-weight: 600;"></i> إضافة تصنيف  </a>
                            </span>
                        </div>
                    </div>
                                    ...
                                    @if(count($data)>0 && !empty($data))
                                        @foreach($data as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{config('classification_storage'). $item->image}}" width="200" height="100" alt="">
                                                </td>
                                                <td style="text-align: center;">
                                                    <a href="{{url('dashboard/classification/edit/'.$item->id)}}" class="text-info mr-2">
                                                        <i class="nav-icon i-Eye font-weight-bold " ></i>
                                                    </a>
                                                    <a href="{{url('dashboard/classification/delete/'.$item->id)}}" class="text-danger mr-2">
