                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
                                <div class="card-body text-center">
                                    <i class="i-Flag"></i>
                                    <div class="content">
                                        <p class="text-muted mt-2 mb-0">الأقسام</p>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
                                <div class="card-body text-center">
                                    <i class="i-Library"></i>
                                    <div class="content">
                                        <p class="text-muted mt-2 mb-0" style="width: 84px;">البراندات</p>
                                        <p class="text-primary text-24 line-height-1 mb-2">{{$data['brands']}}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
                                <div class="card-body text-center">
                                    ...
                                    <div class="content">
                                        <p class="text-muted mt-2 mb-0" style="width: 94px;">الطلبات الجديدة</p>
                                        <p class="text-primary text-24 line-height-1 mb-2">{{$data['new_orders']}}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
