        ...
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-header">
                    <div class="card-title mb-3">  <strong class="text-primary">تعديل مدينة {{$data->city}}</strong></div>
                </div>
                    ...
                    <form id="change-pwd" action="{{url('dashboard/city/update')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group mb-3">
                                ...
                                <input type="text" class="form-control" name="city" id="city" placeholder="الإسم " value="{{$data->city}}" autocomplete="off">
                                @if ($errors->has('city'))
