$(document).ready(function () {
  ...
  if ($("html").prop("dir") == "rtl") {
    ...
    $(".items-slider .items").slick({
      ...
      dots: false,
      arrows: true,
      prevArrow: '<a class="prev-arrow"><img src="'+baseUrl+'/public/assets/front/ar/img/icons/prev.png"></a>',
      nextArrow: '<a class="next-arrow"><img src="'+baseUrl+'/public/assets/front/ar/img/icons/next.png"></a>',
      focusOnSelect: true,
      rtl: true,
      responsive: [
        {
