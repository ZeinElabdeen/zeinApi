...
<div class="page-header">
      <div class="container">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{url('vendor/dashboard')}}"><i class="fas fa-home"></i> {{ __('front.home') }}</a></li>
  ...
  //else{
   ...
   other_data.forEach(function(fields){
   	formdata.append(fields.name, fields.value);
         ...
         $.ajax({
          url: '{{url("vendor/dashboard/update-profile")}}',
          type: 'POST',
          data:formdata,
          async: true,
					cache:false,
          ...
          success: function (data) {
            if($.isEmptyObject(data.error)){
                ...
                location.href ='{{url("vendor/dashboard/my-profile")}}';
              }else{
                var error_msg = '';
