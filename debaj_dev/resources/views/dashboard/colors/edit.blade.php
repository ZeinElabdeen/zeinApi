    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form id="change-pwd" action="{{url('dashboard/colors/update')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6 form-group mb-3">
                              ...
                              <input type="text" class="form-control" name="name_ar" id="name_ar" placeholder="الإسم العربي" value="{{$data->name_ar}}" autocomplete="off">
                          ...
                          <div class="col-md-6 form-group mb-3">
                              ...
                              <input type="text" class="form-control" name="name_en" id="name_en" placeholder="الإسم الإنجليزي" value="{{$data->name_en}}" autocomplete="off">
                          ...
                          <div class="col-md-3 form-group mb-3">
                              ...
                              <input type="color" class="form-control" name="code" id="code" data-role="colorinput" placeholder="كود اللون" value="{{$data->code}}" autocomplete="off">
                              @if ($errors->has('code'))
                                  <span class="text-danger" role="alert">
