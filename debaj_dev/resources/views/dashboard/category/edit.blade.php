    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form id="change-pwd" action="{{url('dashboard/category/update')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="avatar-upload">
                                    ...
                                    <div class="avatar-preview">
                                        <div id="imagePreview" style="background-image: url({{config('category_storage').$data->image}});">
                                        </div>
                                    </div>
                                </div>
                                @if ($errors->has('image'))
                            ...
                            <div class="col-md-6 form-group mb-3">
                                ...
                                <input type="text" class="form-control" name="tags_ar" id="tags_ar" data-role="tagsinput" placeholder="الاشارات بالعربي" value="{{$data->tags_ar}}" autocomplete="off">
                            </div>
                            <div class="col-md-6 form-group mb-3">
                                <label for="tags_en"> الاشارات بالانجليزيه </label>
                                <input type="text" class="form-control" name="tags_en"  id="tags_en" data-role="tagsinput" placeholder="الاشارات بالانجليزي" value="{{$data->tags_en}}" autocomplete="off">
                            </div>
