    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form id="change-pwd" action="{{url('dashboard/ad/store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group mb-3">
                               ...
                               <input type="text" class="form-control" name="text_ar" id="text_ar" placeholder="عنوان بالعربيه" value="{{old('text_ar')}}" autocomplete="off">
                            ...
                            <div class="col-md-6 form-group mb-3">
                               ...
                               <input type="text" class="form-control" name="text_en" id="text_en" placeholder="عنوان بالانجليزية" value="{{old('text_en')}}" autocomplete="off">
                            ...
                            <div class="col-md-6 form-group mb-3">
                               ...
                               <input type="text" class="form-control" name="link" id="link" placeholder="الرابط" value="{{old('link')}}" autocomplete="off">
                               @if ($errors->has('link'))
                                <span class="text-danger" role="alert">
