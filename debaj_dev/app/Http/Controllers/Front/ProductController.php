...
class ProductController extends Controller
{
    ...
    {
        $vendor_id = auth()->guard('users')->user()->id;
      //  $products = Product::with('category','product_images')->orderBy('id','desc')->get();
        $products = Product::where('vendor_id',$vendor_id)->orderBy('id','desc')->get();
    ...
    public function create()
    {
        ...
        $colors = Colors::all();
        return view('vendor.product.create',compact('categories','colors'));
    }
    ...
    public function store(Request $request)
    {
        ...
        {
          return redirect('vendor/dashboard/product/index')->with('success', 'تم الاضافة بنجاح');
        }
  ...
  public function edit($id)
  {
        ...
        $colors = Colors::all();
        return view('vendor.product.edit',with([
            'product' => $product,
    ...
    public function update(Request $request, $id)
    {
      ...
      //  $product->size_num = $request->size_num;
